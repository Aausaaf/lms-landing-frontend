...
import { filterOptions } from "../constants/testSeriesData";
    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
            ...
            <div className="lg:hidden mb-4">
                <button onClick={() => setIsOpen(!isOpen)} className="w-full flex items-center justify-between bg-orange-50 text-orange-600 px-4 py-3 rounded-xl font-medium">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 gap-2">
                            <button
                                ...
                                className={`text-left px-3 py-2 rounded-lg text-sm transition-colors ${
                                    filters.subcategory === "All" ? "bg-orange-500 text-white" : "bg-gray-50 text-gray-700 hover:bg-orange-50 hover:text-orange-600"
                                }`}
                            >
                                All
                            </button>
                            {filterOptions.subcategories[filters.category].map((subcategory) => (
                                <button
                                    ...
                                    className={`text-left px-3 py-2 rounded-lg text-sm transition-colors ${
                                        filters.subcategory === subcategory ? "bg-orange-500 text-white" : "bg-gray-50 text-gray-700 hover:bg-orange-50 hover:text-orange-600"
                                    }`}
                                >
                                    {subcategory}
                                </button>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-1 gap-2">
                        {filterOptions.languages.map((language) => (
                            <button
                                ...
                                className={`text-left px-3 py-2 rounded-lg text-sm transition-colors ${
                                    filters.language === language ? "bg-orange-500 text-white" : "bg-gray-50 text-gray-700 hover:bg-orange-50 hover:text-orange-600"
                                }`}
                            >
                                {language}
                            </button>
                    ...
                    <div className="grid grid-cols-1 gap-2">
                        {filterOptions.pricing.map((price) => (
                            <button
                                ...
                                className={`text-left px-3 py-2 rounded-lg text-sm transition-colors ${
                                    filters.pricing === price ? "bg-orange-500 text-white" : "bg-gray-50 text-gray-700 hover:bg-orange-50 hover:text-orange-600"
                                }`}
                            >
                                {price}
                            </button>
                    ...
                    <div className="grid grid-cols-1 gap-2">
                        {filterOptions.duration.map((duration) => (
                            <button
                                ...
                                className={`text-left px-3 py-2 rounded-lg text-sm transition-colors ${
                                    filters.duration === duration ? "bg-orange-500 text-white" : "bg-gray-50 text-gray-700 hover:bg-orange-50 hover:text-orange-600"
                                }`}
                            >
                                {duration}
                            </button>
