      ...
      <nav className="mx-auto flex max-w-[1500px] items-center justify-between p-4 lg:px-8" aria-label="Global">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-center lg:px-8">
          <div className="relative w-full max-w-lg">
            ...
            <Input
              type="search"
              placeholder="Search products, docs, tutorials..."
              className="pl-10 pr-4 py-2 w-full bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-orange-500 focus:border-transparent"
            />
          </div>
        </div>
          ...
          {navigation.main.map((item) => (
            <div key={item.name} className="relative">
              {item.hasDropdown ? (
                ...
                <Link
                  href={item.href}
                  className="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-orange-500 dark:hover:text-orange-400 px-3 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200"
                >
                  {item.name}
                </Link>
              )}
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:items-center lg:gap-x-3">
          <Button variant="ghost" size="icon" className="relative">
            ...
            <Badge className="absolute -top-1 -right-1 h-5 w-5 p-0 text-xs bg-orange-500 hover:bg-orange-600">3</Badge>
          </Button>
          ...
          <div className="relative">
            ...
            {activeDropdown === "profile" && (
              <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 py-2 z-50">
                <Link
                  href="/profile"
                  className="flex items-center gap-3 px-4 py-2 text-sm hover:bg-gray-50 dark:hover:bg-gray-800"
                >
      ...
      {searchOpen && (
        <div className="lg:hidden border-t border-gray-200 dark:border-gray-800 p-4">
          <div className="relative">
            ...
            <Input type="search" placeholder="Search..." className="pl-10 w-full" autoFocus />
          </div>
        </div>
      )}
