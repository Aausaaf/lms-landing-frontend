...
import { Github, Twitter, Linkedin, Mail, Phone, MapPin, ArrowRight, Heart, Star, Users, Award, Zap, Shield } from "lucide-react";
                ...
                <div className="mx-auto max-w-[1500px] px-6 py-12 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-4">Get the latest updates, tutorials, and exclusive content delivered to your inbox.</p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            <div className="flex-1">
                                <Input type="email" placeholder="Enter your email address" className="w-full bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600" />
                            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                            Building beautiful, responsive layouts with modern design principles. Trusted by thousands of developers and companies worldwide.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {features.map((feature) => (
                                <Badge key={feature.name} variant="secondary" className="bg-orange-100 dark:bg-orange-900/20 text-orange-700 dark:text-orange-300">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {footerNavigation.company.map((item) => (
                                <li key={item.name}>
                                    <Link href={item.href} className="text-sm text-gray-600 dark:text-gray-400 hover:text-orange-500 dark:hover:text-orange-400 transition-colors duration-200">
                                        {item.name}
                                    </Link>
                                </li>
                            ))}
